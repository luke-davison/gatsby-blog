...
> Almost 100 metres wide and only 1.8 metres thick at its thinnest point
...
This was not a long walk, maybe 15 minutes. Afterwards I missed a turnoff we ended up at the Fiery Furnace - a series of tight canyons which can be walked if we have a permit, or just photographed from a viewpoint (which is what we did).
