...
Luke argued that based on how blurry it looked, it would have to be well over the horizon, which would make it very tall - impossibly tall.  Betty argued that it looked like a mountain and so it must be a mountain.  Luke pointed out that it was much, much whiter than any other mountains we could see.  Betty pointed out that it was very, very stationary for a cloud.  It was also possible that we'd been walking in the sun too long and we were just sharing a hallucination.
